...
module.exports = function (Renderer) {
    ...
    utils.mixin(Renderer.prototype, {
        ...
        _getLiteral: function (node, f) {
            ...
            switch (type) {
                ...
                case 'FUNC':
                    ...
                    break;
                case 'ASSIGN': // todo: ++/-- oprator in expression
                    // console.log(me._getVar(node.key));
                    break;
                default:
                    break;
            };
        ...
        _getStr: function (node) { // todo: smarty function call in string and ` ` oprator in string
            var me = this;
            var str = node.value;
            var envRe = new RegExp(
                utils.regEscape(me.engine.conf.left_delimiter) 
                + '.*?' 
                + utils.regEscape(me.engine.conf.right_delimiter) , 'g');
