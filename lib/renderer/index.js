...
function addUserDefinedFuncs(engine, jsTpl) {
    ...
    if (matches) {
        ...
        return 'var __func=' + utils.toFuncString(obj) + ';';
    }
    return '';
}
...
Renderer.prototype = {
    ...
    parser: function (flag) {
        ...
        var jsTpl = '';
        if (!flag) {
            jsTpl += '\nvar __h="",__func={},__cap={},__ext={},__assign,smarty={'
            ...
            jsTpl = addClosure(/*addUserDefinedFuncs(this.engine, jsTpl) + */addPhpFuncs(this.engine, jsTpl) + jsTpl);
        }
        else {
