...
Renderer.prototype = {
    ...
    parser: function () {
        ...
        var jsTpl = 'var __f=' + utils.toFuncString(this.engine.func) + ';\nvar __sf={};\nvar __h=[];'
            + 'var __v=function(){var a=Array.prototype.slice.call(arguments);for(var i=0,l=a.length;i<l;i++){var d=a[i];if(d!=undefined)return d;} return undefined;}' // todo: fix undefined.xxx
            + this._init(ast) + '\nreturn __h.join("");'
        // }
